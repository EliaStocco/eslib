...
def prepare_args(description):
    ...
    parser.add_argument("-s", "--show_folders", type=str2bool, help="whether to show folders (default: %(default)s)",default=False)
    parser.add_argument("-d", "--descriptions", **argv, type=str2bool, help="whether to print descriptions (default: %(default)s)", default=False)
