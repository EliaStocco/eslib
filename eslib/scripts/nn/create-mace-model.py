...
def prepare_args(description):
    ...
    parser.add_argument("-ap", "--absolute_path", **argv, type=str2bool, required=False, help="whether to save the --model_path as an absolute path (default: %(default)s)", default=True)
...
def main(args):
    ...
    if "absolute_path" in kwargs: del kwargs["absolute_path"]
