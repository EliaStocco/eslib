...
def prepare_args(description):
    ...
    parser.add_argument("-o", "--output" , type=str, **argv, default="dataset", help="prefix for the output files (default: %(default)s)")
    ...
    parser.add_argument("-r", "--random", type=str2bool, **argv, default=True, help="whether the atomic structures are chosen randomly (default: %(default)s)")
    parser.add_argument("-s", "--seed", type=int, **argv, default=None, help="seed of the random numbers generator (default: %(default)s)")
    parser.add_argument("-pbc", "--pbc"  ,  type=str2bool, **argv, default=True, help="whether the system is periodic (default: %(default)s)")
