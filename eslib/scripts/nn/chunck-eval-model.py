...
from eslib.io_tools import read_json, count_lines

#---------------------------------------#
# Description of the script's purpose
description = "Evaluate a model by chuncking the input structures."
...
def prepare_args(description):
    ...
    parser.add_argument("-N" , "--chunk_size"   , **argv, type=int  , required=True , help="chunk size")
...
def main(args):
    ...
    if hasattr(model,"charges_key"):
        if not structures.is_there(charges_model.charges_key):
