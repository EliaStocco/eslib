...
def prepare_args(description):
    ...
    parser.add_argument("-rd", "--ref_dipole" , **argv, type=str, required=True , help="name of the reference dipoles")
...
def main(args):
    ...
    #------------------#
    # dipole
    print("\n\tExtracting '{:s}' from the provided atomic structures ... ".format(args.ref_dipole), end="")
    linear = trajectory.get(args.ref_dipole)
    print("done")
