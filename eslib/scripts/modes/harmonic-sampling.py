...
def prepare_args():
    ...
    parser.add_argument("-nm", "--normal_modes", type=str     , **argv, help="normal modes file generated by 'ipi2normal-modes.py' (default: %(default)s)", default="normal-modes.pickle")
    parser.add_argument("-d" , "--dof"         , type=int     , **argv, help="dof to be skipped (default: %(default)s)", default=3)
    parser.add_argument("-t" , "--temperature" , type=float   , **argv, help="temperature [K] (default: %(default)s)", default=300)
    parser.add_argument("-n" , "--number"      , type=int     , **argv, help="number of samples (default: %(default)s)", default=100)
    parser.add_argument("-s" , "--seed"        , type=int     , **argv, help="seed of the random number generator: specify a number for reproducibility (default: %(default)s)", default=None)
    parser.add_argument("-a" , "--absolute"    , type=str2bool, **argv, help="consider the absolute value of the eigenvalues (default: %(default)s)", default=False)
    parser.add_argument("-o" , "--output"      , type=str     , **argv, help="output file (default: %(default)s)", default='output.xyz')
