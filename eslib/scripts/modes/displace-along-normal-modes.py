...
def prepare_args(description):
    ...
    argv = {"metavar":"\b"}
    parser.add_argument("-i" , "--input"        , type=str     , required=False, **argv, help="file with the atomic structure to be displaced [a.u.] (default: %(default)s)", default=None)
    parser.add_argument("-if", "--input_format" , type=str     , required=False, **argv, help="format of the input file (default: %(default)s)" , default=None)
    ...
    parser.add_argument("-od" , "--out_dis"     , type=str     , required=False, **argv, help="*.txt output file with the displacements (default: %(default)s)", default=None)
    parser.add_argument("-o" , "--output"       , type=str     , required=False, **argv, help="output file [a.u.] (default: %(default)s)", default='displaced-structures.extxyz')
    parser.add_argument("-of", "--output_format", type=str     , required=False, **argv, help="ormat of the output file (default: %(default)s)", default=None)
    return parser
