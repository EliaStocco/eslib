...
def prepare_args(description):
    ...
    argv = {"metavar":"\b"}
    parser.add_argument("-i", "--input", type=str, required=True , **argv, help="normal modes file generated by 'ipi2normal-modes.py' (default: %(default)s)", default="normal-modes.pickle")
