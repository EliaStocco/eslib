...
def prepare_args(description):
    ...
    parser.add_argument("-b"  , "--n_bins"          , type=ilist   , required=False, **argv, help="number of bins (default: %(default)s)", default=[100,200,400,600,800,1000])
    parser.add_argument("-n"  , "--block_length"    , type=int     , required=False, **argv, help="length of each block (default: %(default)s)", default=50)
    parser.add_argument("-o"  , "--output"          , type=str     , required=False, **argv, help="output file with the Shannon entropy (default: %(default)s)", default='entropy.csv')
    parser.add_argument("-p"  , "--plot"            , type=str     , required=False, **argv, help="plot (default: %(default)s)", default='entropy.pdf')
    return parser
