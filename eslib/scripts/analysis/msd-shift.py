...
#---------------------------------------#
description = "Compute the Mean Squared Displacement (MSD) and the diffusion coefficient of one atomic species by averaging over the initial reference configuration."
