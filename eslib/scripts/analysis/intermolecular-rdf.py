...
description = "Compute and plot the Intermolecular Radial Distribution Function (RDF)."
documentation = "Please run 'divide-into-water-molecules.py' beforehand."
...
def main(args):
    ...
    if args.same_cell:
        ...
        with eslog("Calculating RDF"):
            ...
            fortran_intermolecular_rdfs_fixed_cell(rdf, posA, posB, args.rmin, args.rmax, cell, inverseCell, partitionA, partitionB, massA, massB)
    else:
