...
description = "Socket driver for a confining potential."

choices = ["LJwall","NanoTube"]
...
def prepare_args(description):
    ...
    parser.add_argument("-p" , "--potential"   , **argv, required=True , type=str     , help="potential type", choices=choices)
...
def main(args):
    ...
    #------------------#
    args.potential = str(args.potential).lower()

    if args.potential == "ljwall":
