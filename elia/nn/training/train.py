...
import time
from copy import copy
from elia.functions import add_default
from elia.functions import remove_empty_folder
from elia.functions import remove_files_in_folder
from elia.nn.plot   import plot_learning_curves
from elia.nn.training.functions import save_checkpoint
from elia.nn.training.functions import get_all_dataloader
from elia.nn.training.functions import get_all
...
def train(
    ...
    if make_dataloader is None:
        from elia.nn.dataset import make_dataloader as _make_dataloader
        make_dataloader = \
    ...
    match parameters["scheduler"].lower():
        ...
        case "ma":
            from elia.nn.functions import MovingAverage
